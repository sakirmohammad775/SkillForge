      ...
      <div className="w-full max-w-6xl bg-[#0a0a0a] rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row border border-white/5 shadow-2xl relative z-10">
          ...
          <div className="relative z-10 h-full p-12 flex flex-col justify-between">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl md:text-6xl font-black text-white leading-tight uppercase tracking-tighter">
                Start Your <br />
                <span className="bg-gradient-to-r from-pink-500 to-orange-400 bg-clip-text text-transparent">Mastery Journey</span>
              </h1>
        ...
        <div className="md:w-1/2 bg-black p-8 md:p-16 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <h2 className="text-3xl font-black text-white mb-2 uppercase tracking-tighter">Create Account</h2>
            <p className="text-gray-500 text-[10px] font-bold mb-10 uppercase tracking-[0.3em]">
              Already a member? <Link href="/login" className="text-pink-500 hover:text-orange-400 transition-colors">Login Here</Link>
            </p>
            ...
            <form className="space-y-5">
              ...
              <div className="flex items-center gap-3 py-2">
                <input type="checkbox" className="accent-pink-500 w-4 h-4 rounded border-none bg-white/5" />
                <label className="text-[10px] text-gray-500 font-bold uppercase tracking-widest cursor-pointer leading-relaxed">
                  I accept the <span className="text-gray-300 underline">Terms of Service</span>
                </label>
              </div>
            ...
            <div className="relative my-10 text-center">
              ...
              <span className="relative bg-black px-4 text-[10px] text-gray-600 font-bold uppercase tracking-widest">Rapid Integration</span>
            </div>
